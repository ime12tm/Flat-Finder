...
import { updateUser } from "../firebase/api/auth";
...
const MyProfile = () => {
  ...
  const onSubmit = async (data: Partial<User>) => {
    ...
    try {
      setIsLoading(true);
      toastWarning("Updating your profile. Please wait...");
      ...
      else console.log("An error has occured while updating user");
      console.log(error);
      ...
      >
        <div>
          ...
          <div className="w-full flex flex-col justify-center gap-[10px] items-center pt-20">
            <h3 className="text-[19px] text-gray-800 font-bold font-poppins">My Profile</h3>
          </div>
